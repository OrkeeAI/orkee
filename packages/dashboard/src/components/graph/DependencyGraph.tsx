// ABOUTME: Cytoscape-based dependency graph visualization component
// ABOUTME: Renders interactive file dependency graph with node styling and interactions
...
import { useDependencyGraph } from '@/hooks/useGraph';
