...
pub async fn create_router() -> Router {
    ...
    let preview_router = Router::new()
        ...
        .route("/servers/:project_id/status", get(preview::get_server_status))
        .route("/servers/:project_id/logs", get(preview::get_server_logs))
        .route("/servers/:project_id/logs/clear", post(preview::clear_server_logs))
        .route("/servers/:project_id/activity", post(preview::update_server_activity))
